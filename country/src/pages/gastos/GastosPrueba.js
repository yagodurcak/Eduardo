...
const [base, setBase] = useState(0);
    ...
    const importExcel = (e) => {
      ...
      reader.onload = (event) => {
        ...
        setdata5(convertToJson(headers, fileData))
      }   
       if (file) {
        if (getExention(file)) {
    ...
    const buscarCotizacion = async() => {
     ...
     const rtdo3=  rtdo2.map(obj=> ({ id:obj.propertyId, name: obj.user.name, document: obj.user.document , consumo: 0}))
    ...
    return (
        ...
        <div>
          ...
          <div className="flex justify-between mt-16">
            ...
            {/* <input type="file" className="btn" onChange={imageChange} /> */}
            <div>
